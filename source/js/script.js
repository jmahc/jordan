...
Jmac.home.init_variables = function() {
  ...
  t.controllerProjects = new ScrollMagic.Controller({
    globalSceneOptions: {
      duration: t.scrollDurationProjects
    }
  });
  t.scrollDurationVideo = 400;
  t.controllerVideo = new ScrollMagic.Controller({
    globalSceneOptions: {
      duration: t.scrollDurationVideo
    }
  });
}
